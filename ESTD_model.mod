...
# Version2 of the model.
# See documentation : https://energyscope-td.readthedocs.io/en/v2.2/ 
# See repo :  https://github.com/energyscope/EnergyScope/tree/v2.2
...
# [Figure 10.] From annual energy demand to hourly power demand. End_uses is non-zero only for demand layers.
...
# [Eq. 41] Constant flow of import for resources listed in SET RES_IMPORT_CONSTANT
...
# [Eq. 19] limit the Energy to power ratio for storage technologies except EV batteries
...
# [Eq. 32] limit the Energy to power ratio for EV batteries
...
# [Eq. 22] DHN: assigning a cost to the network equal to the power capacity connected to the grid
...
# [Eq. 27] relation between decentralised thermal solar power and capacity via period capacity factor.
...
# [Eq. 28] Overall thermal solar is the sum of specific thermal solar 	
...
# [Eq. 29]: Decentralised thermal technology must supply a constant share of heat demand.
...
# [Eq. 30] Compute the equivalent size of V2G batteries based on the installed capacity, the capacity per vehicles and the battery capacity per EVs technology
...
# [Eq. 31]  Impose EVs to be supplied by their battery.
...
# [Eq. 33]  Impose a minimum state of charge at some hours of the day:
...
# [Eq. 35] Calculation of max heat demand in DHN (1st constraint required to linearised the max function)
